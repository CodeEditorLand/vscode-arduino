...
export const messages = {
	...
	SWITCH_TO_BUNDLED_CLI:
		"Use Arduino CLI bundled with this extension instead?",
	REMOVE_ARDUINO_IDE_SUPPORT:
		"Support for the legacy Arduino IDE will be removed soon.",
	...
	ARDUINO_CLI_NOT_EXECUTABLE:
		"The bundled Arduino CLI could not be marked executable. Ensure that VS Code is able to execute:",
};
