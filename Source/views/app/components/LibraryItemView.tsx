...
> {
	...
	private buildLibrarySectionHeader(lib) {
		return (
			<div>
				<span className="listitem-header">{lib.name}</span>
				{lib.builtIn && <span> Built-In </span>}
				{lib.author && (
					<span className="listitem-author">
						{" "}
						by <span className="listitem-header">{lib.author}</span>
					</span>
				)}
				{lib.installed && (
					<span className="listitem-author">
						...
						<span className="listitem-installed-header">
							INSTALLED
						</span>
					</span>
				)}
	...
	private buildLibrarySectionBody(lib) {
		return (
			<div>
				<span className="listitem-header">{lib.sentence}</span>{" "}
				{lib.paragraph}
				{lib.website && (
					<div>
						<a
		...
		return (
			<div className="listitem-footer">
				{this.state.isInstalling && (
					<div className="toolbar-mask theme-bgcolor">
						Installing...
					</div>
				)}
				{this.state.isUninstalling && (
					<div className="toolbar-mask theme-bgcolor">Removing</div>
				)}
				{lib.installed && (
