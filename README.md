...
-   The supported legacy Arduino IDE versions are `1.6.x` and up to, but not
    including, `2.0.0`.
...
extension. These can be set in global user preferences <kbd>Ctrl</kbd> +
...
You can find the full list of issues on the
